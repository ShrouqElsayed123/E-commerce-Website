...
export default function Card(productInfo) {
    const {title,description,price,imageCover,ratingsAverage,id}=productInfo;
 ...
 <div className="card shadow " >
  ...
  <div className='layer d-flex gap-3 justify-content-center align-items-center'>
    ...
    <NavLink to=""><i className="fa-solid fa-cart-shopping" 
    onClick={()=>{addProductToCard({productId:id})}}></i></NavLink>
